...
class FullSystemAlignmentTest {
    ...
    public function run() {
        ...
        $this->test("Columna guardian_id en twilio_messages", strpos($this->sql, 'guardian_id UUID') !== false);
        ...
        $this->test("Seed: 8 roles (7 + GUARDIAN)", substr_count($this->sql, "INSERT INTO roles") === 8);
        ...
        if ($this->failed === 0) {
            ...
            echo "     ✅ Supabase: ejecutar nexo_full_migration.sql + nexo_seed.sql\n";
