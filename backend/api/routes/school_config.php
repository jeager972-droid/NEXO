...
if ($cleanPath === '/school/groups-onboarding' && $method === 'POST') {
    ...
    try {
        ...
        // Sensores por grupo
        foreach ($groupsToInsert as $g) {
            // Buscar el group_id recién creado
        ...
        securityLog('GROUPS_ONBOARDING_COMPLETED', "School: $schoolId, By: $userId ($role), Grupos: " . count($groupsToInsert) . ", Sensores: $sensorsCreated", $userId, $schoolId);
