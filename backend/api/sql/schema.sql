...
--   - Funciones (helpers + lógica de negocio)
--   - Triggers
...
--
-- GENERADO: 2026-08-15 — Consolidación de nexo_full_migration.sql +
--   migration_iteracion3.sql + fix_migration.sql + fix_teacher_work_shift.sql +
--   2026-20 a 2026-27 (todas las migraciones funcionales integradas).
-- =============================================================================
...
SELECT register_migration(
    'schema.sql'::VARCHAR,
    '2026-08'::VARCHAR,
    'Esquema canónico consolidado: todas las tablas, constraints, índices, funciones, triggers, RLS, particiones automáticas, retención, seed mínimo'::TEXT,
    NULL::VARCHAR,
    CURRENT_USER::VARCHAR,
    NULL::INTEGER,
    'Consolidación final pre-hardware. Integra nexo_full_migration.sql + migration_iteracion3.sql + 2026-20 a 2026-27.'::TEXT
);
