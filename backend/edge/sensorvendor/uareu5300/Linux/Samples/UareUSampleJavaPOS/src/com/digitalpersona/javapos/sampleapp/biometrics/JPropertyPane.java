    ...
    public JPropertyPane(BiometricsControl113 biometricsControl, ImagePanel imagePanel) {
        ...
        TableModel dataModel = new AbstractTableModel() {
            ...
            public void setValueAt(Object aValue, int row, int column) {
		            ...
		            // For raw sensor data, show message instead of garbage.
		            String propertyName = ps.getProperties()[row][0];
		            String value = ps.getProperties()[row][1];
		            if (propertyName == "RawSensorData")
		            {  
		            		ps.getProperties()[row][1] = value;
		            }
		            else
		            {
