	...
	implements ActionListener
{
	...
	public static Reader.Priority	OpeningModeFlag = Reader.Priority.EXCLUSIVE;
	...
	public void actionPerformed(ActionEvent e){
		if(e.getActionCommand().equals(ACT_SELECTION)){
			m_reader = Selection.Select(m_dlgParent, m_collection);
			if(null != m_reader){
			...
			if(null == m_reader){
				...
				Capture.Run(m_dlgParent, m_reader, false);
			}
		}
			...
			if(null == m_reader){
				...
				OpeningModeFlag = Reader.Priority.EXCLUSIVE;
				Capture.Run(m_dlgParent, m_reader, true);
			}
		}
			...
			if(null == m_reader){
				...
				Verification.Run(m_dlgParent, m_reader);
			}
		}
			...
			if(null == m_reader){
				...
				Identification.Run(m_dlgParent, m_reader);
			}
		}
			...
			if(null == m_reader){
				...
				Enrollment.Run(m_dlgParent, m_reader);
			}
		}
