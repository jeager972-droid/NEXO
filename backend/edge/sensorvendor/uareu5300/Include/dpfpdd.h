...
/**
\brief Spoof detection library not found or can't be loaded.
*/
#define DPFPDD_E_PAD_LIBRARY       DPERROR(0x21)

/**
\brief Spoof detection database/classifier not found or can't be loaded.
*/
#define DPFPDD_E_PAD_DATA          DPERROR(0x22)

/**
\brief Spoof detection license not found or invalid.
*/
#define DPFPDD_E_PAD_LICENSE       DPERROR(0x23)

/**
\brief Failure to perform spoof detection.
*/
#define DPFPDD_E_PAD_FAILURE       DPERROR(0x24)
...
#define DPFPDD_PARMID_MOTIONDETECT_ENABLE 0x107  /**< enable detection of finger motion and/or detection of multiple fingers */
#define DPFPDD_PARMID_FRAME_INTERVAL	  0x110  /**< frame interval settings */
#define DPFPDD_PARMID_PTAPI_GET_GUID      0x302  /**< read persistent serial number from Eikon devices, the expected data size is 16 bytes */
#define DPFPDD_PARMID_PAD_ENABLE          0x200  /**< enable or disable presentation attack detetion */
#define DPFPDD_PARMID_PAD_DP_ENABLE       0x201  /**< enable or disable 2D (printed) presentation attack detection for DP readers */
#define DPFPDD_PARMID_PAD_CONFIDENCE      0x202  /**< setting or reading the confidence level for the presentation attach detection (not for all algorithms) */

#define DPFPDD_PARMID_SPOOFDETECT_ENABLE  DPFPDD_PARMID_PAD_DP_ENABLE /**< for backward compatibility */
