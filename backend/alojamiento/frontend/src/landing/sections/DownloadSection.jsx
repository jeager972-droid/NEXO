...
const PLATFORMS = [
  {
    ...
    href: 'https://nexo-bay-mu.vercel.app/app/instalar/android',
    icon: (
  ...
  },
  {
    ...
    href: 'https://nexo-bay-mu.vercel.app/app/instalar/ios',
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" stroke="currentColor"
        strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    href: 'https://nexo-bay-mu.vercel.app/app/instalar/windows',
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" stroke="currentColor"
        strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    name: 'Mac',
    glowColor: 'rgba(180,180,185,0.35)',   // Apple silver
    href: 'https://nexo-bay-mu.vercel.app/app/instalar/mac',
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" stroke="currentColor"
        strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    href: 'https://nexo-bay-mu.vercel.app/app/instalar/linux',
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" stroke="currentColor"
        strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
