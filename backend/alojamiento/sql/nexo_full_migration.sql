...
CREATE POLICY jbl_select ON jwt_blocklist FOR SELECT USING(is_super_rector());
CREATE POLICY jbl_insert ON jwt_blocklist FOR INSERT WITH CHECK(is_super_rector());
