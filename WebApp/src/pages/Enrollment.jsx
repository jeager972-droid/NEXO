...
const Enrollment = () => {
  ...
  return (
    <div className="space-y-12 py-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-soft dark:shadow-soft-dark border border-gray-50 dark:border-slate-800/50">
