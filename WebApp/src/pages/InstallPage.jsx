      ...
      <div className="install-page" style={{
        ...
        <div style={{
          ...
          <div className="install-card" style={{
            ...
            {/* CASO 5: android/windows/mac/linux sin prompt — mensaje simple */}
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: 0, fontSize: '0.85rem', color: '#4a6e4c', lineHeight: 1.6 }}>
                      Abre el menú de tu navegador o busca el ícono <strong>⊕</strong> en la barra de direcciones para instalar NEXO.
                    </p>
                  </div>
                </div>
              </div>
