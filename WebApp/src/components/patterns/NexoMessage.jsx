...
export const NexoMessage = ({ time, text, evidence, action, onAction, urgent, className }) => (
  <div className={clsx('rounded-surface border p-4 transition-all duration-fast', urgent ? 'border-[color-mix(in_oklch,var(--nx-warning)_var(--nx-border-mix),transparent)] bg-[color-mix(in_oklch,var(--nx-warning)_var(--nx-subtle-mix-w),transparent)]' : 'border-[var(--nx-border)] bg-[var(--nx-surface)]', className)}>
