...
const variants = {
  success: {
    ring: 'bg-[var(--nx-subtle-bg-success)] text-[var(--nx-success)]',
    Icon: CheckCircle2,
    animate: 'animate-seal',
  },
  warning: {
    ring: 'bg-[var(--nx-subtle-bg-warning)] text-[var(--nx-warning)]',
    Icon: AlertTriangle,
    animate: '',
  },
  danger: {
    ring: 'bg-[var(--nx-subtle-bg-danger)] text-[var(--nx-danger)]',
    Icon: XCircle,
    animate: '',
  },
  pending: {
...
export const OperationResult = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto max-w-lg py-6 sm:py-10 min-h-[60vh] flex flex-col justify-center space-y-6"
    >
