...
export function formatCellValue(key, value) {
  ...
  if (sv === 'en proceso') return <span className="inline-flex items-center rounded-full border border-[var(--nx-warning)] bg-[var(--nx-subtle-bg-warning)] px-2 py-0.5 text-caption font-medium text-[var(--nx-warning)]">En Proceso</span>;
  if (sv === 'resuelto') return <span className="inline-flex items-center rounded-full border border-[var(--nx-success)] bg-[var(--nx-subtle-bg-success)] px-2 py-0.5 text-caption font-medium text-[var(--nx-success)]">Resuelto</span>;
